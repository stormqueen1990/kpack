...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in MetadataOrder) DeepCopyInto(out *MetadataOrder) {
	{
		in := &in
		*out = make(MetadataOrder, len(*in))
		for i := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetadataOrder.
func (in MetadataOrder) DeepCopy() MetadataOrder {
	if in == nil {
		return nil
	}
	out := new(MetadataOrder)
	in.DeepCopyInto(out)
	return *out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MetadataOrderEntry) DeepCopyInto(out *MetadataOrderEntry) {
	*out = *in
	if in.Group != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetadataOrderEntry.
func (in *MetadataOrderEntry) DeepCopy() *MetadataOrderEntry {
	if in == nil {
		return nil
	}
	out := new(MetadataOrderEntry)
	in.DeepCopyInto(out)
	return out
}
